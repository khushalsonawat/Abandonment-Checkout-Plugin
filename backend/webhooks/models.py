...
class CartAndCheckoutInfo(models.Model):
    ...
    cart_creation_time = models.TimeField(default = datetime.datetime.now())
...
class CheckoutReminderInfo(models.Model):
    cart = models.OneToOneField(CartAndCheckoutInfo, on_delete = models.CASCADE,related_name="timings")
